...
name_trace_file = "txt/trace_NB-BOW-FV.txt"
name_eval_file = "txt/eval_NB-BOW-FV.txt"
...
# Remove the words that only have one frequency for both yes/no
def filterVocabulary():
    repeat = True
